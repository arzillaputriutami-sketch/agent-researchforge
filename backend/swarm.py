"""ResearchForge Agents multi-agent reasoning core.
...
PROJECT_NAME = 'ResearchForge Agents'
DOMAIN = 'crypto research intelligence'
AUDIENCE = 'research analysts and venture scouts'
AGENT_ROLES = ['Claim Extractor', 'Contradiction Hunter', 'Citation Graph Builder', 'Narrative Risk Analyst', 'Briefing Compiler']
SIGNALS = ['source_quality', 'claim_overlap', 'contradiction_count', 'market_attention', 'evidence_age_days']
SCENARIOS = ['new L2 thesis', 'token unlock impact', 'protocol revenue narrative']
