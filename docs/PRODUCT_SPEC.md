# Product Spec — ResearchForge Agents

## Problem

Research analysts and venture scouts need fast, explainable decisions in crypto research intelligence workflows. Static dashboards are not enough; the product must show how agents reason, verify, and produce action plans.
