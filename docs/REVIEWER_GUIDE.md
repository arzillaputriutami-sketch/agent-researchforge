# Reviewer Guide — ResearchForge AI
...
## Product objective
Generate research memo from fragmented protocol diligence notes.
...
print(run_pipeline_sync("ResearchForge AI", {"subject":"research_memo reviewer smoke"}))
PY
```
